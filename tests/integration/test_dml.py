...
class TestControlsDML:
    ...
    def setup_teardown(self):
        ...
        cursor = conn.cursor()
        # Clear controls table before each test
    ...
    def test_get_control_by_vgcpid(self):
    ...
    def test_get_all_active_controls(self):
...
class TestCommentsDML:
    ...
    def test_add_comment_to_test(self):
    ...
    def test_get_comments_for_test(self):
